...
const Chat = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const chatData = await sendChatRequest(content);
      setChatMessages((prev) => [...prev, ...chatData.chats]); // Fix state update
    } catch (error) {
  ...
  return (
    <Box sx={{ display: "flex", flex: 1, width: "100%", height: "100%", mt: 3, gap: 3, paddingBottom: "60px" }}>
      ...
      <Box sx={{ display: "flex", flex: { md: 0.8, xs: 1, sm: 1 }, flexDirection: "column", px: 3 }}>
        ...
        <div style={{ width: "90%", marginBottom: "60px", marginTop: "auto", padding: "10px", borderRadius: 16, backgroundColor: "rgb(17, 29, 39)", display: "flex", flexDirection: "column" }}>
          <input ref={inputRef} type="text" style={{ width: "90%", height: "30px", backgroundColor: "transparent", padding: "5px", border: "none", outline: "none", color: "white", fontSize: "15px" }} />
          <IconButton onClick={handleSubmit} sx={{ ml: "auto", color: "white" }}>
            <IoMdSend />
          </IconButton>
        </div>
  ...
  return (
    <Box sx={{ display: "flex", flex: 1, width: "100%", height: "100%", mt: 3, gap: 3, paddingBottom: "60px" }}>
      ...
      <Box sx={{ display: "flex", flex: { md: 0.8, xs: 1, sm: 1 }, flexDirection: "column", px: 3 }}>
        ...
        <div style={{ width: "90%", marginBottom: "60px", marginTop: "auto", padding: "10px", borderRadius: 16, backgroundColor: "rgb(17, 27, 39)", display: "flex", alignItems: "center" }}>
          <input
            ref={inputRef}
            type="text"
            style={{
